...
test_eval! {
    ...
    ("#{1: \"one\", 1.5: [1, 2, 3], true: #{1: 2}} == #{1: \"one\", 1.5: [1, 2, 3], true: #{1: 2}}", "true", true_hash_hash),
    ("#{1: 2} == #{2: 1}", "false", false_hash),
...
test_eval! {
    ...
    ("#{1: \"one\", 1.5: [1, 2, 3], true: #{1: 2}} != #{1: \"one\", 1.5: [1, 2, 3], true: #{1: 2}}", "false", false_hash_hash),
    ("#{1: 2} != #{2: 1}", "true", true_hash),
